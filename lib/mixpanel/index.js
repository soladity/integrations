...
function formatProperties(track, settings){
  ...
  extend(properties, {
    ...
    mp_lib: 'Segment.io' + (track.proxy('context.library.name') || ''),
    $search_engine: track.proxy('properties.searchEngine'),
    $referrer: track.referrer(),
    $username: track.username(),
    $query: track.query(),
    // from : https://github.com/mixpanel/mixpanel-android/blob/34eb2205882cae137597dfb16f9c13545de32ca5/src/main/java/com/mixpanel/android/mpmetrics/AnalyticsMessages.java#L403
    $lib_version: track.proxy('context.library.version'),
